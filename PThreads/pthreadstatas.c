...
struct thread_data{//https://hpc-tutorials.llnl.gov/posix/passing_args/, https://hpc-tutorials.llnl.gov/posix/example_code/hello_arg2.c
  int threadids;
  int runs;
...
int counter = 0;
volatile int lock = 0;//https://en.wikipedia.org/wiki/Test-and-set
